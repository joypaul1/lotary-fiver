...
@section('title', 'Add lottarySection')
@section('page-header')
    <i class="fa fa-info"></i> Add LottarySection
@endsection
@push('css')
    <style>
...
@section('content')
    ...
    <div class="col-sm-9">
        <form class="form-horizontal" method="post" action="{{route('backend.lottarySection.store')}}"
              role="form"
