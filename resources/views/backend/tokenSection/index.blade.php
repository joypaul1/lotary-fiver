...
@section('content')
    @include('backend.components.page_header', [
       'fa' => 'fa fa-pencil',
       'name' => 'tokenSection Create',
       'route' => route('backend.tokenSection.create')
    ])
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <th class="bg-dark" style="width: 40%">percent</th>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group btn-group-mini btn-corner">
                        <a href="{{ route('backend.tokenSection.edit', $data->id) }}"
                    ...
                    <form action="{{ route('backend.tokenSection.destroy', $data->id)}}"
